...
class Bint {
    ...
    public:
        ...
        bint& operator=(const std::string&);

        // Unary arithmetic operators:
        bint operator+() const;   // unary +
        bint operator-() const;   // unary -
        ...
        bint operator/(const long long&) const;
        bint operator%(const long long&) const;
        bint operator+(const std::string&) const;
        bint operator-(const std::string&) const;
        bint operator*(const std::string&) const;
        bint operator/(const std::string&) const;
        bint operator%(const std::string&) const;
        ...
        bint& operator++();       // pre-increment
        bint& operator--();       // pre-decrement
        bint operator++(int);     // post-increment
        bint operator--(int);     // post-decrement
...
/*
    ===========================================================================
    Random number generating functions for bint
    ===========================================================================
*/
...
bint::bint(const std::string& num) {
...
/*
    to_int
    ------
    Converts a bint to an int.
    NOTE: If the bint is out of range of an int, stoi() will throw an
    out_of_range exception.
*/

int bint::to_int() const {
...
/*
    to_long
    -------
    Converts a bint to a long int.
    NOTE: If the bint is out of range of a long int, stol() will throw an
    out_of_range exception.
*/

long bint::to_long() const {
...
/*
    to_long_long
    ------------
    Converts a bint to a long long int.
    NOTE: If the bint is out of range of a long long int, stoll() will throw
    an out_of_range exception.
*/

long long bint::to_long_long() const {
...
bint& bint::operator=(const std::string& num) {
    bint temp(num);
    value = temp.value;
    sign = temp.sign;
...
/*
    -bint
    -------
    Returns the negative of a bint.
*/
...
bool bint::operator==(const long long& num) const {
    return *this == bint(num);
}
...
bool operator==(const long long& lhs, const bint& rhs) {
    return bint(lhs) == rhs;
}
...
bool bint::operator==(const std::string& num) const {
    return *this == bint(num);
}
...
bool operator==(const std::string& lhs, const bint& rhs) {
    return bint(lhs) == rhs;
}
...
/*
    abs
    ---
    Returns the absolute value of a bint.
*/

bint abs(const bint& num) {
...
/*
    big_pow10
    ---------
    Returns a bint equal to 10^exp.
...
/*
    pow (bint)
    ------------
    Returns a bint equal to base^exp.
*/

bint pow(const bint& base, int exp) {
    if (exp < 0) {
        if (base == 0)
...
bint pow(const long long& base, int exp) {
    return pow(bint(base), exp);
}
...
bint pow(const std::string& base, int exp) {
    return pow(bint(base), exp);
...
/*
    sqrt
    ----
    Returns the positive integer square root of a bint using Newton's method.
    NOTE: the input must be non-negative.
*/

bint sqrt(const bint& num) {
    if (num < 0)
    ...
    bint sqrt_current = big_pow10(num.to_string().size() / 2 - 1);
...
/*
    gcd(bint, bint)
    -------------------
    Returns the greatest common divisor (GCD, a.k.a. HCF) of two bints using
    Euclid's algorithm.
*/

bint gcd(const bint &num1, const bint &num2){
    bint abs_num1 = abs(num1);
    bint abs_num2 = abs(num2);
...
bint gcd(const bint& num1, const long long& num2){
    return gcd(num1, bint(num2));
}
...
bint gcd(const bint& num1, const std::string& num2){
    return gcd(num1, bint(num2));
}
...
bint gcd(const long long& num1, const bint& num2){
    return gcd(bint(num1), num2);
}
...
bint gcd(const std::string& num1, const bint& num2){
    return gcd(bint(num1), num2);
}
...
/*
    lcm(bint, bint)
    -------------------
    Returns the least common multiple (LCM) of two bints.
*/

bint lcm(const bint& num1, const bint& num2) {
    if (num1 == 0 or num2 == 0)
        return 0;
...
bint lcm(const bint& num1, const long long& num2){
    return lcm(num1, bint(num2));
}
...
bint lcm(const bint& num1, const std::string& num2){
    return lcm(num1, bint(num2));
}
...
bint lcm(const long long& num1, const bint& num2){
    return lcm(bint(num1), num2);
}
...
bint lcm(const std::string& num1, const bint& num2){
    return lcm(bint(num1), num2);
}
...
bint bint::operator-(const bint& num) const {
    ...
    bint result;      // the resultant difference
    // identify the numbers as `larger` and `smaller`
    std::string larger, smaller;
    if (abs(*this) > abs(num)) {
        larger = this->value;
...
/*
    bint * bint
    ---------------
    Computes the product of two bints using Karatsuba's algorithm.
...
bint bint::operator*(const bint& num) const {
    ...
    if (abs(*this) <= FLOOR_SQRT_LLONG_MAX and abs(num) <= FLOOR_SQRT_LLONG_MAX)
        ...
        bint prod_high, prod_mid, prod_low;
...
std::tuple<bint, bint> divide(const bint& dividend, const bint& divisor) {
    bint quotient, remainder, temp;
...
/*
    bint / bint
    ---------------
    Computes the quotient of two bints using the long-division method.
    The operand on the RHS of the division (the divisor) is `num`.
*/

bint bint::operator/(const bint& num) const {
    bint abs_dividend = abs(*this);
    bint abs_divisor = abs(num);
...
/*
    bint % bint
    ---------------
    Computes the modulo (remainder on division) of two bints.
...
bint bint::operator%(const bint& num) const {
    ...
    if (abs_dividend <= LLONG_MAX and abs_divisor <= LLONG_MAX)
        ...
        bint quotient = abs_dividend / abs_divisor;
...
bint bint::operator+(const long long& num) const {
    return *this + bint(num);
}
...
bint operator+(const long long& lhs, const bint& rhs) {
    return bint(lhs) + rhs;
}
...
bint bint::operator+(const std::string& num) const {
    return *this + bint(num);
}
...
bint operator+(const std::string& lhs, const bint& rhs) {
    return bint(lhs) + rhs;
}
...
std::istream& operator>>(std::istream& in, bint& num) {
    std::string input;
    in >> input;
    num = bint(input);  // remove sign from value and set sign, if exists
